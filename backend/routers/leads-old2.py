...
async def _upsert_lead(session: AsyncSession, lead: Lead):
    ...
    if existing:
        ...
        existing.keywords = lead.company.keywords
        existing.founded_year = lead.company.founded_year
        existing.revenue = lead.company.revenue
        ...
        record = LeadRecord(
            ...
            keywords=lead.company.keywords,
            founded_year=lead.company.founded_year,
